  ...
  const checkAuthStatus = async (retryCount = 0) => {
    try {
      ...
      if (res.ok) {
        ...
        console.log('User authenticated:', userData.display_name || userData.id);
        setLoggedIn(true);
        setUser(userData);
        setLoading(false);
        fetchTopData(timeRange);
      } else if (res.status === 401 && retryCount < 2) {
        // Retry up to 2 times with a delay for session to sync
        console.log('Auth failed, retrying in 2 seconds...');
        ...
        <div className="dashboard-content">
          ...
          <div className="select-container">
            ...
            <select id="timeRangeSelect" value={timeRange} onChange={handleTimeRangeChange}>
              ...
              <option value="long_term">Last 6 Months</option>
